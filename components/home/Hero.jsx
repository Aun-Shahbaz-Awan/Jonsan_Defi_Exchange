...
function Hero() {
  return (
    <div className="flex flex-col items-center my-24 text-primary">
      ...
      <h4 className="text-5xl text-primary font-medium mt-10 mb-6">
      ...
      <button className="bg-primary text-white rounded-full px-6 py-3 flex items-center">
      ...
      <div className="w-full flex items-center justify-between max-w-4xl mt-20">
