  ...
  return (
    <div className="text-primary my-12 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mx-3 md:mx-0 gap-8">
        {/* Column 1 */}
        <div className="bg-gradient-to-r from-grad-one via-grad-two to-grad-three rounded-xl p-7">
        ...
        {/* Column 2 */}
        <div className="bg-gradient-to-r from-grad-three via-grad-two to-grad-one rounded-xl px-6 py-6">
