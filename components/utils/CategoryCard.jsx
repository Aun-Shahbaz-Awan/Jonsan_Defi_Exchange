    ...
    <div className={`${data?.bgColor} text-primary px-7 py-10 rounded-xl`}>
      ...
      <div className="flex justify-between">
        <div className="w-3/4">
          ...
          <p className="text-sm text-gray-500 leading-5">{data?.description}</p>
        </div>
      ...
      <div className="px-2 my-10">
        <div className="flex justify-between text-sm mb-3">
          <span className="text-gray-500">Max Multiple</span>
          <span className="font-medium">{data?.MM}</span>
        </div>
        <div className="flex justify-between text-sm mb-3">
          <span className="text-gray-500">Current Liquidity Available</span>
          <span className="font-medium">{data?.CLA}</span>
        </div>
        <div className="flex justify-between text-sm mb-3">
          <span className="text-gray-500">Variable Annual Fee</span>
